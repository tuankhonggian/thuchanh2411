...
update_option( 'wpforms_license', [
	'key' => 'DkMIW8r3VJ9MtJ16uTpluCQXaFvOo8E3',
	'type' => 'elite',
	'is_expired' => false,
	'is_disabled' => false,
	'is_invalid' => false,
...
add_action( 'plugins_loaded', function() {
	add_filter( 'pre_http_request', function( $pre, $parsed_args, $url ) {
		...
		elseif ( strpos( $url, 'https://wpforms.com/templates/api/get/' ) !== false ) {
			...
			} elseif ( $query_args['tgm-updater-action'] === 'deactivate-key' ) {
				return [
					'response' => [ 'code' => 200, 'message' => 'ОК' ],
					'body'     => '{"success":"You have deactivated the key from this site successfully.","type":"elite"}',
				];
			} else {
				return $pre;
			}
